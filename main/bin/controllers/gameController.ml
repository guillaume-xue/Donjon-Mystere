...
let run () =
  ...
  let rec game_loop var_game last_time name = 
    let (map_textures, player_textures, enemy_textures, items_textures, bag_textures, my_map, my_player, enemy, loots) = var_game in
    if window_should_close () then begin
      ...
      begin
        ...
        draw_game my_map player enemy loots map_textures player_textures enemy_textures items_textures bag_textures;
        game_loop (map_textures, player_textures, enemy_textures, items_textures, bag_textures, my_map, player, enemy, loots) last_time name
      end
  in
    ...
    if window_should_close () then
      ...
      if screen_state = Game then
        begin
          ...
          game_loop (map_textures, player_textures, enemy_textures, items_textures, bag_textures, my_map, my_player, enemy, loots) list_of_last_time map_name;
        end
      else
        begin
